        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="cont text-center">
              <h3 className="num"><span className="gr">10000<span className="thin">+</span></span></h3>
              ...
              <a href={appData.itemStoreLink} target = "_blank" className="btn rounded-pill bg-blue4 fw-bold text-white mt-50">
